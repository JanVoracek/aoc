...
const cards = 'J23456789TQKA'.split(''); // J is a Joker - the weakest individual card
...
function getType(deck: Deck): Type {
  ...
  groups[0] += jokers; // Make the hand as strong as possible

  if (jokers === 5 || groups[0] === 5) return 'FIVE_OF_A_KIND';
